...
class SnakeGame:
    def __init__(self):
        ...
        self.frame1 = Frame(window, width=600, height=400)  #
        self.frame2 = Frame(window, width=600, height=400)  #
    ...
    def draw_food(self):
        ...
        self.canvas.create_rectangle(
            self.foodx,
            self.foody,
            self.foodx + self.step,
            self.foody + self.step,
            fill="red",
            tags="food",
        )  # food view #
    ...
    def draw_snake(self):
        ...
        self.canvas.create_rectangle(
            x[0] + 5, y[0] + 5, x[0] + 10, y[0] + 10, fill="black", tags="snake"
        )  #
    ...
    def random_food(self):
        return (
            random.randrange(11, 570, self.step),
            random.randrange(11, 340, self.step),
        )
    ...
    def isdead(self):
        if (
            self.snakeX[0] < 8
            or self.snakeX[0] > 580
            or self.snakeY[0] < 8
            or self.snakeY[0] > 350
        ):
            return True  #
